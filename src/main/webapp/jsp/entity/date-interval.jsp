...
<form class="entity" name="find-auto" method="post" action="/control">
    ...
    <p><label for="start-date" class="short"><b>Rental start date and time: </b></label>
        <input type="datetime-local" id="start-date" name="start-date" size="50" value=""/></p>
    <p><label for="hours" class="short"><b>Rental duration in hours: </b></label>
    ...
    <p><label for="second-driver" class="short"><b>Full name: </b></label>
