...
<form class="entity" name="client-login" method="post" action="/control">
    ...
    <p><label for="login" class="short-label"><b>Login: </b></label>
    ...
    <p><label for="new-password" class="short-label"><b>New password: </b></label>
        <input type="password" id="new-password" name="new-password" size="50" value=""/></p>
    <p><b><label>Repeat new password</label></b><br>
        <label for="new-password2" class="short-label"><b>New password: </b></label>
