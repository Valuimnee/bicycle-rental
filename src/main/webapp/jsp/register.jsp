...
<main class="container-fluid mb-5">
    <div class="register-block">
        ...
        <form class="no-resubmit mt-0" name="register-form" method="post" action="/control">
            ...
            <c:if test="${requestScope.wrong=='wrong-info'}"><p class="mb-2">
                <fmt:message key="register.wrong-info"/></p></c:if>
            <p class="mb-2 text-center"><label class="mb-0 pt-0"><b><fmt:message key="register.login-info"/></b></label></p>
            ...
            <p class="mb-2"><b><label class="container-fluid text-center mb-0 pt-0">
